...
calc_consume <- function(population, 
  ...
  return(list(consumed_N_dairy = consumed_N_dairy, consumed_N_egg = consumed_N_egg,
              consumed_N_fish = consumed_N_fish, consumed_N_foreign_vegetable = consumed_N_foreign_vegetable,
              consumed_N_meat = consumed_N_meat, consumed_N_vegetable = consumed_N_vegetable))  
}
# 
