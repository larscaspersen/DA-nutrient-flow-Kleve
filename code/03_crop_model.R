...
crop_function <- function(arable_land,
  ...
  crop_df <- data.frame(crop = c('bean',
                                 'corn', 
                                 'fodder_peas', 
                                 'mais_silage', 
                                 'oat',
                                 ...
                                 'triticale', 
                                  'winter_barley', 
                                 'winter_wheat'),
                        land_share = c(new_share_beans,
                                       new_share_corn, 
                                       new_share_fodder_peas,
                          new_share_mais_silage,
                          new_share_oat, 
                          new_share_oilseed_rape,
                          new_share_potato, 
                          new_share_rye, 
                          new_share_sugar_beet,
                          new_share_summer_barley, 
                        ...
                        dm = c(dm_beans, 
                               ...
                               dm_winter_barley,
                               dm_winter_wheat),
                        yield_share = c(yield_share_beans,
                                        yield_share_corn,
                                        yield_share_fodder_peas,
                                        yield_share_mais_silage,
                                        yield_share_oat,
                                        yield_share_oilseed_rape,
                                        yield_share_potato,
                                        yield_share_rye,
                                        yield_share_sugar_beet,
                                        yield_share_summer_barley,
                                        yield_share_summer_wheat,
                                        yield_share_triticale,
                                        yield_share_winter_barley,
                                        yield_share_winter_wheat),
                        N_yield = c(N_yield_beans,N_yield_corn,
                                    N_yield_fodder_peas,
                                    N_yield_mais_silage,
                                    N_yield_oat,
                                    N_yield_oilseed_rape,
                                    N_yield_potato,
                                    N_yield_rye,N_yield_sugar_beet,
                                    N_yield_summer_barley,
                                    N_yield_summer_weat,
                                    N_yield_triticale,
                                    N_yield_winter_barley,
                                    N_yield_winter_weat),
                        N_leftover = c(N_leftover_beans,
                                       N_leftover_corn,
                                       N_leftover_foder_peas,
                                       N_leftover_mais_silage,
                                       N_leftover_oat,
                                       N_leftover_oilseed_rape,
                                       N_leftover_potato,
                                       N_leftover_rye,
                                       N_leftover_sugar_beet,
                                       N_leftover_summer_barley,
                                       N_leftover_summer_wheat,
                                       N_leftover_triticale,
                                       N_leftover_winter_barley,
                                       N_leftover_winter_wheat),
